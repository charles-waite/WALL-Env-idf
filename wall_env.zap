{
  ...
  "package": [
    {
      ...
      "path": "esp-matter/connectedhomeip/connectedhomeip/src/app/zap-templates/zcl/zcl.json",
      "type": "zcl-properties",
      "category": "matter",
      "version": 1,
    ...
    {
      "pathRelativity": "relativeToZap",
      "path": "esp-matter/connectedhomeip/connectedhomeip/src/app/zap-templates/app-templates.json",
  ...
  "endpointTypes": [
    ...
    {
      "id": 2,
      "name": "Air Quality Sensor Endpoint Type",
      "deviceTypeRef": {
        "code": 44,
        "profileId": 259,
    ...
    {
      "id": 3,
      "name": "Temperature Sensor Endpoint Type",
      "deviceTypeRef": {
        "code": 770,
        "profileId": 259,
        "label": "MA-temperature-sensor",
        "name": "MA-temperature-sensor",
        "deviceTypeOrder": 0
      },
      "deviceTypes": [
        {
      ...
      "deviceTypeName": "MA-temperature-sensor",
      "deviceTypeCode": 770,
      "deviceTypeProfileId": 259,
      "clusters": [
        {
    ...
    {
      "id": 4,
      "name": "Humidity Sensor Endpoint Type",
      "deviceTypeRef": {
        "code": 775,
        "profileId": 259,
        "label": "MA-humidity-sensor",
        "name": "MA-humidity-sensor",
        "deviceTypeOrder": 0
      },
      "deviceTypes": [
        {
      ...
      "deviceTypeName": "MA-humidity-sensor",
      "deviceTypeCode": 775,
      "deviceTypeProfileId": 259,
      "clusters": [
        {
    ...
    {
      "id": 5,
      "name": "Pressure Sensor Endpoint Type",
      "deviceTypeRef": {
        "code": 773,
        "profileId": 259,
        "label": "MA-pressure-sensor",
        "name": "MA-pressure-sensor",
        "deviceTypeOrder": 0
      },
      "deviceTypes": [
        {
      ...
      "deviceTypeName": "MA-pressure-sensor",
      "deviceTypeCode": 773,
      "deviceTypeProfileId": 259,
      "clusters": [
        {
  ...
  "endpoints": [
    ...
    },
    {
      "endpointId": 1,
      "endpointTypeIndex": 2,
      "endpointTypeName": "Temperature Sensor Endpoint Type",
      "networkId": 0,
      "parentEndpointIdentifier": null,
      "profileId": 259
    },
    {
      "endpointId": 2,
      "endpointTypeIndex": 3,
      "endpointTypeName": "Humidity Sensor Endpoint Type",
      "networkId": 0,
      "parentEndpointIdentifier": null,
      "profileId": 259
    },
    {
      "endpointId": 3,
      "endpointTypeIndex": 4,
      "endpointTypeName": "Pressure Sensor Endpoint Type",
      "networkId": 0,
      "parentEndpointIdentifier": null,
      "profileId": 259
    },
    {
      "endpointId": 4,
      "endpointTypeIndex": 1,
      "endpointTypeName": "Air Quality Sensor Endpoint Type",
      "networkId": 0,
      "parentEndpointIdentifier": null,
      "profileId": 259
    }
